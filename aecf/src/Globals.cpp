...
void Globals::parseCommandLine(int argc, char **argv)
{
...
bool Globals::hasOption(std::string optionName)
{
...
Globals::ExistingOption Globals::optionExists(std::string optionName)
{
...
void Globals::addOption(Globals::OptionShort optionShort, Globals::OptionLong optionLong, Globals::OptionExplanation optionExplanation)
{
